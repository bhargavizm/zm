...
export default function LoginPage() {
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 overflow-y-auto">
            <div
                ref={modalRef}
                className="relative flex flex-col md:flex-row bg-white text-[#001a1a] rounded-2xl shadow-2xl w-[95%] max-w-4xl my-6 mx-auto"
            >
                {/* Close Button */}
                <button
                    onClick={() => router.push('/')}
                ...
                {/* Right Section (Form) */}
                <div className="w-full md:w-1/2 flex flex-col justify-center items-center bg-white text-[#001a1a] p-6 rounded-2xl md:rounded-l-2xl">
                    <h1 className="text-3xl text-loginBlue font-semibold text-center">Welcome!</h1>
                    <h4 className="font-light text-sm text-loginBlue text-center mt-1">Sign in to your ZM QR Code account</h4>
                ...
                peer-focus:-top-2 peer-focus:text-sm peer-focus:text-[#001a1a] peer-focus:bg-white"
                                ...
                                {input.type === 'password' && (
                                    <button
                                        ...
                                        className="absolute right-3 top-1/2 transform -translate-y-1/2 text-gray-500"
                                    >
                                        {visiblePasswords[input.id] ? <FiEyeOff size={18} /> : <FiEye size={18} />}
                                    </button>
                                )}
                            </div>
                        ))}
                        ...
                        <div className="flex items-start mt-3 w-full gap-2 text-sm">
                            ...
                            <label>
                                ...
                                <a href="/terms-conditions" target="_blank">
                                    <span className="text-mainGreen">terms</span>
                                </a>{' '}
                                and{' '}
                                <a href="/privacy-policies" target="_blank">
                                    <span className="text-mainGreen">privacy</span>
                                </a>{' '}
                                policy
                            </label>
                        </div>
                ...
                <div className="hidden md:flex bg-mainGreen md:w-1/2 flex-col justify-center items-center text-white p-6 rounded-r-2xl">
                    <Image src="/logos/zm-full.jpg" alt="logo" width={150} height={150} className="m-5 mb-10" />
                    <h1 className="text-xl font-semibold text-center px-4">
                        World's No.1 QR Code Generating and Managing Platform
                    </h1>
                    <Image src="/qr-image-login.png" alt="qr-image" width={400} height={400} className="m-5" />
                    <h4 className="text-md font-thin text-center px-4">Trusted by the World's Top Brands.</h4>
                </div>
            </div>
        </div>
    );
