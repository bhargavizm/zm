...
//           <div className="relative w-full max-w-sm focus-within:max-w-md transition-all duration-300 flex justify-end group shadow-2xl">
//             {/* Search Icon */}
//             <FiSearch className="absolute left-4 top-1/2 -translate-y-1/2 text-mainGreen text-lg pointer-events-none transition-colors duration-300 group-focus-within:text-mainGreen" />
...
//               onChange={(e) => setSearchQuery(e.target.value)}
//               placeholder="Search services..."
//               className="w-full pl-12 pr-4 py-3 rounded-lg bg-white text-darkGreen font-bold placeholder:text-teal-800 border border-white/20 focus:outline-none focus:ring-2 focus:ring-teal-300 focus:border-teal-900 shadow-md transition-all duration-300"
//             />
//           </div>
//         </div>
//         {/* Services Grid */}
