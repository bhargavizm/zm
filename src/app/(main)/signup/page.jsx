...
export default function SignupPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      localStorage.setItem("otpFlow", "signup"); // ✅ mark this flow as signup
          ...
          >
            ...
            <div className="flex justify-between w-full gap-2 mb-4">
              <button
                ...
                type="button"
                className={`flex-1 text-sm bg-[#e6e6e6] px-4 py-2 rounded-sm ${
                  active === "new"
...
/>
  ...
  <p className="text-xs text-red-500 mt-1">{errors.phone}</p>
            ...
            <div className="flex items-start mt-3 w-full gap-2 text-sm">
              ...
              <label>
                I agree to{" "}
                <a href="/terms-conditions" className="text-mainGreen">
                  terms
                </a>{" "}
                and{" "}
                <a href="/privacy-policies" className="text-mainGreen">
                  privacy
                </a>{" "}
                policy
              </label>
            ...
            <div className="flex gap-4 mt-2">
              <button
                ...
                type="button"
                className="flex items-center justify-center hover:bg-gray-100 rounded-md p-2"
              >
                <FcGoogle size={30} />
              </button>
              <button
        ...
        <div className="hidden md:flex bg-mainGreen md:w-1/2 flex-col justify-center items-center text-white p-6">
          <Image
            ...
            height={150}
          />
          <h1 className="text-xl font-semibold text-center px-4 pt-12 animate-bounce">
