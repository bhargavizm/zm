        ...
        <div className='h-screen w-1/2 flex flex-col justify-center items-center text-white border-2 rounded-r-2xl'>
            ...
            <form action="" className="flex flex-col items-center mt-8">
                ...
                <div className="flex w-[20rem] justify-between">
                    <button
                        type="button"
                        className="w-auto text-sm bg-[#e6e6e6] text-[#001a1a] px-6 py-2 rounded-sm transition duration-300 hover:bg-[#d4d4d4] cursor-pointer active:border-b-mainGreen"
                    >
                        I'm a new user
                    </button>
                    <button
                ...
                <div className="relative w-[20rem] mt-3">
                    ...
                    <label className='text-sm text-[#001a1a] ml-2'>I agree to <span className='text-mainGreen'>terms</span> and <span className='text-mainGreen'>privacy</span> policy</label>
                </div>
                <div className="relative w-[20rem] mt-3">
                    <input type="checkbox" className='border-2 border-mainGreen' />
