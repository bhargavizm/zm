...
const PropertyContent = () => {
  ...
  const handleConfirmedSubmit = async () => {
    ...
    for (const [sectionKey, sectionFields] of Object.entries(otherSections)) {
      for (const [fieldKey, value] of Object.entries(sectionFields)) {
    ...
    try {
      const response = await axios.post("/api/services/property", formData);
  ...
  const resetForm = () => {
    updateDynamicForm("propertyDetails", null, null, {
      basicInfo: {
        propertyName: "",
        propertyType: "",
        ownerName: "",
