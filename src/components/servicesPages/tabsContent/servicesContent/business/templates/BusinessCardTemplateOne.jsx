...
const BusinessCardTemplateOne = ({ businessForm, profileImage, brandLogo }) => {
    ...
    return (
        <div className="w-full mx-auto rounded-xl bg-black/70 text-white overflow-y-auto scrollbar-hide shadow-2xl relative" style={{ fontFamily: 'Montserrat, Arial, sans-serif' }}>
