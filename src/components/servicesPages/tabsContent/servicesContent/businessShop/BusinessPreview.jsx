...
const BusinessPreview = () => {
  ...
  return (
    ...
    <div className="relative w-[350px] h-[600px] rounded-[40px] border-[14px] border-gray-800 shadow-xl overflow-y-auto scrollbar-hide flex flex-col text-gray-800 bg-white">
      {/* Background layer */}
      {isImage && (
        <img
          src={bgDesign}
