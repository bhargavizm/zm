...
//             {/* Use menuBookFormData here */}
//             <input value={menuBookFormData.restaurantName} onChange={(e) => setMenuBookFormData({ ...menuBookFormData, restaurantName: e.target.value })} placeholder="Name of Business" className="w-full border px-4 py-2 rounded" />
...
//               ))}
//               {/* Use menuBookFormData here */}
//               <button onClick={() => setMenuBookFormData(prev => ({ ...prev, menuItems: [...prev.menuItems, { name: '', description: '', price: '', image: '', visible: true }] }))} className="mt-2 px-3 py-1 bg-[#004d4d] text-white rounded">Add Image</button>
//             </div>
