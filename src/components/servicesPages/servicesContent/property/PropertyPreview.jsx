...
const PropertyPreview = () => {
  ...
  return (
    <div className="max-w-[300px] mx-auto border-[16px] border-black rounded-[40px] overflow-hidden shadow-lg relative bg-white">
      {/* iPhone notch */}
      <div className="w-full h-[30px] bg-black absolute top-0 left-0 right-0 rounded-t-[24px] z-10" />

      {/* Background image layer */}
      <div
        className="absolute inset-0 bg-cover bg-center opacity-20"
        style={{ backgroundImage: "url('/services-service/property.jpg')" }}
      />

      {/* Foreground content layer */}
      <div className="relative z-10 h-[600px] overflow-y-auto px-4 pt-6 pb-4">
        <h1 className="text-2xl font-bold text-center text-[#008080] mb-6">
          🏡 Property Preview
        </h1>

        {/* Basic Info */}
        {hasBasicInfo && (
          <div className="border p-4 rounded shadow mb-4 bg-white/80 backdrop-blur-sm">
