...
const WifiPreview = () => {
  ...
  return (
    <div className="flex items-center justify-center py-10">
      <div className="w-[280px] h-[580px] border-[12px] border-black rounded-[2rem] shadow-2xl relative overflow-hidden">

        {/* Background Image */}
        <div
          className="absolute inset-0 bg-cover bg-center"
          style={{ backgroundImage: "url('/services-service/wifi.jpg')" }}
        />

        {/* Top Indicators */}
        <div className="absolute top-1 left-1/2 transform -translate-x-1/2 w-16 h-1.5 bg-gray-400 rounded-full z-20"></div>
        <div className="absolute top-3 left-[calc(50%-28px)] w-14 h-3 bg-gray-200 rounded-xl z-20"></div>

        {/* Text Content */}
        <div className="relative z-20 h-full w-full rounded-[1.8rem] p-4 overflow-y-auto no-scrollbar flex flex-col items-center text-center pt-9">
