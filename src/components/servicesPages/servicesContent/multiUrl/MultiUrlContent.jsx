...
const platformIcons = {
  ...
  custom: <FaLink className="text-gray-600" />,
};
...
const MultiUrlContent = () => {
  ...
  const handleNfcToggle = () => {
    if (!nfcEnabled) setShowNfcModal(true);
    else setNfcEnabled(false);
  };
  ...
  const cancelNfc = () => setShowNfcModal(false);
    ...
    <>
      <div className="space-y-6">
        ...
        <div className="flex items-center gap-4 mt-2">
          ...
          >
            <span
              className={`absolute left-1 top-1 h-6 w-6 bg-white rounded-full shadow transition-transform
      ...
      {showNfcModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/30 backdrop-blur-md">
          <div className="bg-white rounded-xl p-6 max-w-sm w-full relative border border-teal-300">
            <button
              onClick={cancelNfc}
            ...
            <p className="text-sm">
              You're enabling <strong>NFC features</strong>.<br />
              This is a <strong>premium</strong> feature.<br />
              <span className="text-[#008080] font-semibold">₹499/year</span>
            </p>
