...
const DemoForm = ({ onClose }) => {
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center backdrop-blur-md bg-black/30 px-4">
      <div className="bg-white rounded-xl shadow-xl w-full max-w-5xl max-h-[90vh] relative flex flex-col overflow-hidden">
        {/* Close Button */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 h-full">
          ...
          <div className="hidden md:block bg-mainGreen h-full">
            <DemoFormDesign />
          </div>

          {/* Scrollable Form Section */}
          <div className="overflow-y-auto scrollbar-hide max-h-[90vh] pr-2 p-4">
            <DemoFormPage />
          </div>
        </div>
      </div>
