    ...
    <section className="bg-slate-100 padding-lr py-20">
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
        ...
        <div className="lg:col-span-8">
          ...
          <h2 className="text-mainGreen font-bold text-4xl mb-3">
            {dictionary.qrCodeTracking.heading}
          </h2>
          ...
          <h4 className="mb-5 font-semibold text-slate-500">
            {dictionary.qrCodeTracking.subheading}
          </h4>
          ...
          <p className="text-md">
            {dictionary.qrCodeTracking.paragraph1}
          </p>
          ...
          <p className="text-md my-6">
            {dictionary.qrCodeTracking.paragraph2}
          </p>
          ...
          <p className="text-md">
            {dictionary.qrCodeTracking.paragraph3}
          </p>
          ...
          <p className="text-md my-6">
            {dictionary.qrCodeTracking.paragraph4}
          </p>
          ...
          <p className="text-md my-6">
            {dictionary.qrCodeTracking.paragraph5}
          </p>
        </div>
      </div>
    </section>
...
//   const trackingText = dictionary.qrCodeTracking || {
//     heading: "Track QR Code Performance in Offline Campaigns",
//     subheading: "The Best Solution for Generating Thousands of QR Codes or eBusiness Cards",
//     paragraph1:
//       "Connect offline marketing with digital engagement. With ZM QR Code Services, you can create static QR codes that direct users from printed materials like brochures, posters, or flyers straight to your website or landing page—making the offline-to-online transition seamless.",
//     paragraph2:
//       "Even with static QR codes, you can still compare engagement across various campaigns. By using different static QR codes for each printed asset or distribution channel, you can monitor which materials are drawing the most attention through scan volume.",
...
//         <div className="lg:col-span-8">
//           <h2 className="text-mainGreen font-bold text-4xl mb-3">
//             {trackingText.heading}
//           </h2>

//           <h4 className="mb-5 font-semibold text-slate-500">
//             {trackingText.subheading}
//           </h4>

//           <p className="text-md">{trackingText.paragraph1}</p>
//           <p className="text-md my-6">{trackingText.paragraph2}</p>
//           <p className="text-md">{trackingText.paragraph3}</p>
//           <p className="text-md my-6">{trackingText.paragraph4}</p>
//           <p className="text-md my-6">{trackingText.paragraph5}</p>
//         </div>
//       </div>
//     </section>
//   );
