...
const Stickers = () => {
  ...
  // 🔹 Render one sticker (free or premium)
  const renderStickerBox = (src, index, isPremium) => {
    ...
    return (
      <div
        key={index}
        onClick={() => handleClick(src, isPremium)}
      ...
      >
        <Image
          ...
          width={60}
          height={60}
          className={`object-contain w-16 h-16 ${!premiumEnabled && isPremium ? "opacity-70 blur-[1px]" : ""}`}
        />
